#!/usr/bin/env bash
# evaluate_reconstruction_med_gan.sh
#
...
# med_gan checkpoint: experiments/tflite_med_gan/final-200000
#
# Reports PSNR / MS-SSIM / LPIPS and BPP. Side-by-side original|reconstruction
# images are saved under OUT_DIR.
#
# Usage:
#   bash evaluate_reconstruction_med_gan.sh
#   bash evaluate_reconstruction_med_gan.sh --csv my_results.csv   (override output path)
...
# ── Configurable paths ──────────────────────────────────────────────────────
VARIANT="med_gan"
CKPT="experiments/tflite_med_gan/final-200000"
