#!/usr/bin/env bash
# evaluate_reconstruction_low_v2.sh
#
...
# tflite_low_v2 checkpoint: experiments/tflite_low_v2/final-2000000
#
# Usage:
#   bash evaluate_reconstruction_low_v2.sh
#   bash evaluate_reconstruction_low_v2.sh --csv my_results.csv   (override output path)
...
# ── Configurable paths ──────────────────────────────────────────────────────
VARIANT="low_v2"
CKPT="experiments/tflite_low_v2/final-2000000"
