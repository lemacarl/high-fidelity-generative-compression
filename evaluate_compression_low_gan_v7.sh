#!/usr/bin/env bash
# evaluate_compression_low_gan_v7.sh
#
...
# models for the tflite_low_gan_v7 checkpoint, for test-image-N (N=1..20) from
# assets/coffee/test-new/.
#
# Unlike evaluate_reconstruction_low_gan_v7.sh (GPU, restores the TF
...
#
# NOTE: tflite_low_gan_v7 must be exported to TFLite first:
#   python -m tflite.conversion.export_tflite \
#       --checkpoint experiments/tflite_low_gan_v7/final-200000 \
#       --out_dir tflite_models_low_gan_v7/
#
# Usage:
#   bash evaluate_compression_low_gan_v7.sh
#   bash evaluate_compression_low_gan_v7.sh --csv my_results.csv   (override output path)
...
#   --checkpoint experiments/tflite_low_gan_v7/final-200000 --out_dir tflite_models_low_gan_v7/`)
MODELS_DIR="tflite_models_low_gan_v7"
...
if [[ ! -d "$MODELS_DIR" ]]; then
    ...
    echo "  python -m tflite.conversion.export_tflite --checkpoint experiments/tflite_low_gan_v7/final-200000 --out_dir $MODELS_DIR"
